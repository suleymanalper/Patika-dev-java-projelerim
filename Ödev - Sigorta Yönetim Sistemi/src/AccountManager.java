...
public class AccountManager {
    ...
    public void login(String email, String pw) throws Main.InvalidAuthenticationException {
        ...
        for (Account account : dataList) {
            ...
            if (account.getUser().getPw().equals(pw) && account.getUser().getEmail().equals(email)) {
                ...
                if ((control.login() == AuthenticationControl.AuthenticationStatus.FAIL)) {
                    throw new Main.InvalidAuthenticationException("ERROR: Invalid email or password");
                } else {
